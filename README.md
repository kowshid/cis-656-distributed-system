...
This repository contains course contents, and assignments for **CIS 656: Distributed Systems**.  
...
Distributed Systems - Third edition, Version 3.03 (2020)\
Maarten van Steen, Andrew S. Tanenbaum


## Tools & Technologies
- Programming languages: Java
- Topics: Socket Programming, Multi-Thread Socket Programming, Remote Procedure Call (RPC), Remote Method Invocation 
(RMI), Callback, Peer-to-Peer (P2P).
